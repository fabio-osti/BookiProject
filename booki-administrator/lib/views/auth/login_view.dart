...
import 'package:booki_administrator/views/auth/forgot_password_view.dart';
import 'package:booki_administrator/views/auth/register_view.dart';
import 'package:booki_administrator/views/auth/verify_email_view.dart';
import 'package:booki_administrator/views/booki/booki_root.dart';
    ...
    FirebaseAuthManager.logIn(_email.text, _password.text)
        .then((_) {
          return Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => const BookiAdministratorRoot()));
        })
        ...
        child: Center(
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              children: [
                SvgPicture.asset("assets/images/logo_admin.svg"),
