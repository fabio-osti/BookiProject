import 'package:booki_administrator/helpers/flutter/cross_platform_scroll_behavior.dart';
import 'package:booki_administrator/services/auth/firebase_auth_manager.dart';
import 'package:booki_administrator/views/auth/login_view.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      scrollBehavior: CrossPlatformScrollBehavior(),
      theme: getTheme(),
      home: initialized
          ? const LoginView()
          : Container(
